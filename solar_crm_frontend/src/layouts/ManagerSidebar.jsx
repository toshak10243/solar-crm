...
// 🟢 Corrected relative path from src/layouts/ OR src/components/Manager/
...
// Synced categorized navigation matching AppRoutes
const navigationSections = [
  {
    subheader: "OVERVIEW",
    items: [
      { title: "Dashboard", icon: <DashboardOutlinedIcon />, path: "/manager/dashboard" },
    ],
  },
  {
    subheader: "WORKSPACE",
    items: [
      { title: "Team Leads", icon: <SolarPowerOutlinedIcon />, path: "/manager/leads" },
      { title: "Sales Team", icon: <GroupsOutlinedIcon />, path: "/manager/team" },
      { title: "Team Follow-ups", icon: <EventNoteOutlinedIcon />, path: "/manager/followups" },
      { title: "Performance Reports", icon: <AssessmentOutlinedIcon />, path: "/manager/reports" },
    ],
  },
  {
    subheader: "ACCOUNT",
    items: [
      { title: "My Profile", icon: <PersonOutlineOutlinedIcon />, path: "/manager/profile" },
    ],
  },
];
