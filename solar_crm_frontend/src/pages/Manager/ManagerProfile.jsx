...
const handlePhotoChange = async (e) => {
    ...
    // 👈 HERE: Change "photo" to "profile_image" to match backend Multer exact field name
...
const handleUpdatePassword = async () => {
    ...
    try {
      ...
      // Backend safe payload - dono naming conventions support karne ke liye:
            ...
            <Paper elevation={0} sx={{ ...cardSx, height: "100%", textAlign: "center", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
              <Box>
                ...
                <Box sx={{ display: "flex", justifyContent: "center", gap: 1, mb: 1.5 }}>
                  <Chip
                    label={profileData?.role_name?.toUpperCase() || "MANAGER"}
                    size="small"
                    sx={{
            ...
            <Paper elevation={0} sx={cardSx}>
              ...
              <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "1fr 1fr" }, gap: 1.5 }}>
                ...
                <TextField
                  fullWidth
                  label="Role"
                  value={profileData?.role_name || "Manager"}
                  disabled
                  size="small"
                  sx={fieldSx(true)}
                />
