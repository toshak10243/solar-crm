...
class _SalesProfileScreenState extends ConsumerState<SalesProfileScreen> {
  ...
  Future<void> _fetchProfile() async {
    ...
    if (result['success'] == true) {
      ...
      setState(() {
        ...
        // Fresh fetch from server = source of truth. Drop any stale local
        // picked file so the network image (with correct URL) is used.
  ...
  // 🟢 Robust URL builder — mirrors the web app's logic exactly so the photo
  // never silently falls back to initials because of a bad path.
  String? _getFormattedImageUrl() {
    ...
    // Cache-bust so a re-uploaded photo with the same filename refreshes.
  ...
  String _getInitials(String? name) {
    if (name == null || name.trim().isEmpty) return 'SE';
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _timelineItem(
                              ...
                              description:
                                  'Initial profile registration and role assignment.',
                              date: _formatDate(
                            ...
                            _timelineItem(
                              ...
                              description:
                                  'Logged in via authenticated Solar CRM portal.',
                              date: _formatDate(
