...
class _AdminProfileScreenState extends ConsumerState<AdminProfileScreen> {
  ...
  // Formatted Image URL Generator with Cache-Busting
  ...
  // Self-contained photo removal method using updateProfile API
  Future<void> _removePhoto() async {
    ...
    if (result['success'] == true) {
      // Clear Flutter Memory Cache so image updates instantly
      PaintingBinding.instance.imageCache.clear();
      PaintingBinding.instance.imageCache.clearLiveImages();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Admin Settings & Profile',
            style: TextStyle(
                fontWeight: FontWeight.w800,
                fontSize: 18,
                color: AppColors.textPrimary)),
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              '@${_profileData?['username']?.toString() ?? 'admin'}',
                              style: const TextStyle(
                                  fontSize: 13,
